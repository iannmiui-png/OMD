    ...
    while True:
        ...
        if c.isalpha() and c.islower():
            ...
            if any(ch.isupper() for ch in left_window):
                ...
                # try random starting states; return the chunk and the S that succeeded
                for _ in range(16):
                    S = random.choice(["/", "\\", "//", "\\\\", "/\\", "\\/"])
                    I = slash(S, chunk)
...
# ---------- use file input ----------
with open("omd.py", "r", encoding="utf-8", errors="replace") as f:
    text = f.read()
...
try:
    while True:
        ...
        # small pause to avoid tight busy loop; adjust or remove if you prefer
        time.sleep(0.12)
